                ...
                {selectedId === 1 ? (
                  <div className="flex flex-col items-center w-full h-full overflow-y-auto">
                    ...
                    <div className="flex flex-col items-center text-center max-w-lg px-4 pb-8">
                      <div className="w-24 h-24 rounded-full bg-white/15 border-2 border-white/30 flex items-center justify-center mb-5">
                      ...
                      <div className="flex flex-wrap justify-center gap-3">
                        <button className="flex items-center gap-2 px-5 py-2.5 border-2 border-white rounded-lg hover:bg-white/20 transition-colors text-white font-medium text-sm">
                  ...
                  <div className="flex flex-col items-center w-full h-full overflow-y-auto">
                    ...
                    <div className="w-full max-w-3xl px-2 space-y-6 pb-8">
                      <div className="bg-white/10 rounded-xl p-6 border border-white/20 backdrop-blur-sm hover:bg-white/15 transition-colors">
                        <div className="w-full h-32 rounded-lg bg-gradient-to-br from-blue-500/20 to-purple-600/20 mb-4 flex items-center justify-center border border-white/10">
                      ...
                      <div className="bg-white/10 rounded-xl p-6 border border-white/20 backdrop-blur-sm hover:bg-white/15 transition-colors">
                        <div className="w-full h-32 rounded-lg bg-gradient-to-br from-emerald-500/20 to-teal-600/20 mb-4 flex items-center justify-center border border-white/10">
                          <Code size={36} className="text-white/30" />
                        </div>
                      ...
                      <div className="bg-white/10 rounded-xl p-6 border border-white/20 backdrop-blur-sm hover:bg-white/15 transition-colors">
                        <div className="w-full h-32 rounded-lg bg-gradient-to-br from-amber-500/20 to-orange-600/20 mb-4 flex items-center justify-center border border-white/10">
                          <Code size={36} className="text-white/30" />
                        </div>
                  ...
                  <div className="flex flex-col items-center w-full h-full overflow-y-auto">
                    ...
                    <div className="w-full max-w-3xl px-2 space-y-6 pb-8">
                      <div className="bg-white/10 rounded-xl p-6 border border-white/20 backdrop-blur-sm hover:bg-white/15 transition-colors">
                        <div className="w-full h-32 rounded-lg bg-gradient-to-br from-cyan-500/20 to-blue-600/20 mb-4 flex items-center justify-center border border-white/10">
